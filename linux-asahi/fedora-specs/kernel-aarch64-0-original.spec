...
- Revert "ACPI: platform_profile: Add support for non-ACPI platforms" (Janne Grunau)
- Revert "HID: lenovo: Remove CONFIG_ACPI dependency" (Janne Grunau)

* Sun Aug 31 2025 Neal Gompa <neal@gompa.dev> [6.16.4-400.asahi]
