...
Source:         https://github.com/containers/libkrun/archive/refs/tags/v1.17.2.tar.gz
...
Requires:       libkrun(aarch-64) = 1.17.2-1
...
rpmuncompress -x 'v1.17.2.tar.gz'
STATUS=$?
if [ $STATUS -ne 0 ]; then
  exit $STATUS
fi
