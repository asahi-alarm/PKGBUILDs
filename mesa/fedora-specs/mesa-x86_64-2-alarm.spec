  ...
  Source0:        https://archive.mesa3d.org/mesa-25.2.0.tar.xz
  ...
  Provides:       mesa-dri-filesystem = 25.2.0-2
  Obsoletes:      mesa-omx-drivers < 25.2.0-2
  ...
  Requires:       mesa-dri-drivers(x86-64) = 25.2.0-2
  ...
  Requires:       (mesa-libGL(x86-64) = 25.2.0-2 if mesa-libGL(x86-64))
  ...
  Requires:       mesa-libgbm(x86-64) = 25.2.0-2
  Requires:       mesa-dri-drivers(x86-64) = 25.2.0-2
  ...
  Requires:       (mesa-libEGL(x86-64) = 25.2.0-2 if mesa-libEGL(x86-64))
  Requires:       libglvnd-devel(x86-64) >= 1:1.3.2
  ...
  Requires:       mesa-filesystem(x86-64) = 25.2.0-2
  ...
  Recommends:     mesa-dri-drivers(x86-64) = 25.2.0-2

  Requires:       (mesa-dri-drivers(x86-64) = 25.2.0-2 if mesa-dri-drivers(x86-64))
  ...
  Requires:       mesa-libOpenCL(x86-64) = 25.2.0-2
  ...
  Requires:       mesa-filesystem(x86-64) = 25.2.0-2
  Obsoletes:      mesa-vulkan-devel < 25.2.0-2
  ...
  Provides:       fex-emu-overlay(x86_64)(mesa) = 25.2.0-2
  Provides:       bundled(mesa) = 25.2.0-2
...
prepare() {
  ...
  cat meson_1.5_rust_build.patch | 
  patch -p1 -s --fuzz=0 --no-backup-if-mismatch -f
