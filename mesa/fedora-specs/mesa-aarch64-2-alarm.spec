  ...
  Source0:        https://archive.mesa3d.org/mesa-26.1.7.tar.xz
  ...
  Provides:       mesa-dri-filesystem = 26.1.7-1
  Obsoletes:      mesa-omx-drivers < 26.1.7-1
  Obsoletes:      mesa-libd3d < 26.1.7-1
  Obsoletes:      mesa-libd3d-devel < 26.1.7-1
  Obsoletes:      mesa-vdpau-drivers < 26.1.7-1
  ...
  Requires:       mesa-dri-drivers(aarch-64) = 26.1.7-1
  ...
  Requires:       (mesa-libGL(aarch-64) = 26.1.7-1 if mesa-libGL(aarch-64))
  Requires:       libglvnd-devel(aarch-64) >= 1:1.3.2
  Provides:       libGL-devel = 26.1.7-1
  Provides:       libGL-devel(aarch-64) = 26.1.7-1
  ...
  Requires:       mesa-libgbm(aarch-64) = 26.1.7-1
  Requires:       mesa-dri-drivers(aarch-64) = 26.1.7-1
  ...
  Requires:       (mesa-libEGL(aarch-64) = 26.1.7-1 if mesa-libEGL(aarch-64))
  Requires:       libglvnd-devel(aarch-64) >= 1:1.3.2
  Requires:       mesa-khr-devel(aarch-64)
  Provides:       libEGL-devel = 26.1.7-1
  Provides:       libEGL-devel(aarch-64) = 26.1.7-1
  ...
  Requires:       mesa-filesystem(aarch-64) = 26.1.7-1
  Requires:       mesa-libgbm(aarch-64) = 26.1.7-1
  Obsoletes:      mesa-libglapi < 25.0.0~rc2-1
  Obsoletes:      mesa-va-drivers < 26.0.0-5
  Provides:       mesa-va-drivers = 26.1.7-1
  Provides:       mesa-va-drivers(aarch-64) = 26.1.7-1
  ...
  Provides:       libgbm = 26.1.7-1
  Provides:       libgbm(aarch-64) = 26.1.7-1
  Recommends:     mesa-dri-drivers(aarch-64) = 26.1.7-1

  Requires:       (mesa-dri-drivers(aarch-64) = 26.1.7-1 if mesa-dri-drivers(aarch-64))
  ...
  Requires:       mesa-libgbm(aarch-64) = 26.1.7-1
  Provides:       libgbm-devel = 26.1.7-1
  Provides:       libgbm-devel(aarch-64) = 26.1.7-1
  ...
  Requires:       mesa-libOpenCL(aarch-64) = 26.1.7-1
  ...
  Requires:       mesa-filesystem(aarch-64) = 26.1.7-1
  Obsoletes:      mesa-vulkan-devel < 26.1.7-1
