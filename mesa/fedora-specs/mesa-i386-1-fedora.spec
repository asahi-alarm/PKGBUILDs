...
Requires:       mesa-dri-drivers(x86-32) = 26.1.6-1
...
Requires:       (mesa-libGL(x86-32) = 26.1.6-1 if mesa-libGL(x86-32))
Requires:       libglvnd-devel(x86-32) >= 1:1.3.2
Provides:       libGL-devel = 26.1.6-1
Provides:       libGL-devel(x86-32) = 26.1.6-1
...
Requires:       mesa-libgbm(x86-32) = 26.1.6-1
Requires:       mesa-dri-drivers(x86-32) = 26.1.6-1
...
Requires:       (mesa-libEGL(x86-32) = 26.1.6-1 if mesa-libEGL(x86-32))
Requires:       libglvnd-devel(x86-32) >= 1:1.3.2
Requires:       mesa-khr-devel(x86-32)
Provides:       libEGL-devel = 26.1.6-1
Provides:       libEGL-devel(x86-32) = 26.1.6-1
...
Provides:       libgbm(x86-32) = 26.1.6-1
Recommends:     mesa-dri-drivers(x86-32) = 26.1.6-1

Requires:       (mesa-dri-drivers(x86-32) = 26.1.6-1 if mesa-dri-drivers(x86-32))
...
Provides:       libgbm-devel(x86-32) = 26.1.6-1
...
Requires:       mesa-libOpenCL(x86-32) = 26.1.6-1
...
cd './'
rm -rf 'mesa-26.1.6'
rpmuncompress -x 'mesa-26.1.6.tar.xz'
STATUS=$?
if [ $STATUS -ne 0 ]; then
  exit $STATUS
fi
