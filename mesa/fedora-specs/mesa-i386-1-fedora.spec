...
Requires:       mesa-dri-drivers(x86-32) = 25.2.1-1
...
Requires:       (mesa-libGL(x86-32) = 25.2.1-1 if mesa-libGL(x86-32))
...
Requires:       mesa-libgbm(x86-32) = 25.2.1-1
Requires:       mesa-dri-drivers(x86-32) = 25.2.1-1
...
Requires:       (mesa-libEGL(x86-32) = 25.2.1-1 if mesa-libEGL(x86-32))
Requires:       libglvnd-devel(x86-32) >= 1:1.3.2
...
Requires:       mesa-filesystem(x86-32) = 25.2.1-1
...
Recommends:     mesa-dri-drivers(x86-32) = 25.2.1-1

Requires:       (mesa-dri-drivers(x86-32) = 25.2.1-1 if mesa-dri-drivers(x86-32))
...
Requires:       mesa-libOpenCL(x86-32) = 25.2.1-1
...
Provides:       fex-emu-overlay(i386)(mesa) = 25.2.1-1
