...
declare -A PACKAGES=(
    ...
    #---
    ["alsa-ucm-conf-asahi"]="fsrc+rpms/alsa-ucm-asahi,alsa-ucm-asahi.spec|aarch64"
    #["asahi-alarm-keyring"]="<has no upstream repo>"
    ["asahi-audio"]="fsrc+rpms/asahi-audio,asahi-audio.spec|aarch64"
    ["asahi-bless"]="fsrc+rpms/rust-asahi-bless,rust-asahi-bless.spec|aarch64"
    ...
    ["libkrun"]="fsrc+rpms/libkrun,libkrun.spec|aarch64"
    ["libkrunfw"]="fsrc+rpms/libkrunfw,libkrunfw.spec|aarch64"
