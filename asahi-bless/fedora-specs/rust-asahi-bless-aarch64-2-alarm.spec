...
package() {
  ...
  #       -n asahi-bless
  install -Dpm0755 -t ${pkgdir}/usr/share/licenses/asahi-bless/ LICENSE
  install -Dpm0755 -t ${pkgdir}/usr/share/licenses/asahi-bless/ LICENSE.dependencies
  _install fakeinstall/usr/bin/asahi-bless

  #          devel
  install -Dpm0755 -t ${pkgdir}/usr/share/licenses/asahi-bless/ %{crate_instdir}/LICENSE
  %{crate_instdir}/

  #       -n rust-asahi-bless+default-devel
