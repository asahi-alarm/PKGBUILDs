...
package() {
  ...
  # -f xkeyboard-config-2.lang -f xkeyboard-config.lang
  ...
  _install fakeinstall/usr/share/man/man7/xkeyboard-config-2.*
  _install fakeinstall/usr/share/X11/xkb
  _install fakeinstall/usr/share/xkeyboard-config-2/
  %ghost %attr(0755, root, root) %dir /usr/share/X11/xkb.rpmmoved

  # devel
  _install fakeinstall/usr/share/pkgconfig/xkeyboard-config-2.pc
